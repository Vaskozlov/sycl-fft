...
enum class normalization { none, forward, backward, orthogonal };
enum class planning_mode { estimate, measure };
enum class provider { automatic, portable_sycl, fftw, cufft, rocfft, onemkl };
...
checked_element_count(const std::vector<std::size_t> &lengths,
                      std::size_t batch_count);
SYCLFFT_CORE_EXPORT double normalization_scale(normalization mode,
                                               direction dir,
