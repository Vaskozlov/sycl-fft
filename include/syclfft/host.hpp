...
public:
  ...
  plan(std::vector<std::size_t> lengths, std::size_t batch_count,
...
plan<Scalar>
plan_many_dft(std::span<const std::size_t> lengths, std::size_t batch_count,
              syclfft::direction direction, plan_options options = {}) {
  return plan<Scalar>({lengths.begin(), lengths.end()}, batch_count, direction,
                      options);
}

template <class Scalar>
plan<Scalar> plan_many_dft(std::initializer_list<std::size_t> lengths,
...
template <class Scalar>
plan<Scalar> plan_dft_1d(std::size_t n, syclfft::direction direction,
                         plan_options options = {}) {
  return plan_many_dft<Scalar>({n}, 1, direction, options);
}

template <class Scalar>
plan<Scalar> plan_dft_2d(std::size_t n0, std::size_t n1,
                         syclfft::direction direction,
                         plan_options options = {}) {
...
template <class Scalar>
plan<Scalar> plan_dft_3d(std::size_t n0, std::size_t n1, std::size_t n2,
                         syclfft::direction direction,
                         plan_options options = {}) {
